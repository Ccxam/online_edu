...
import static vodtest.InitObject.initVodClient;
...
public class TestVod {
    ...
    public static DeleteVideoResponse deleteVideo(DefaultAcsClient client) throws Exception {
        ...
        //支持传入多个视频ID，多个用逗号分隔
        request.setVideoIds("f401e278d4d346ff8df6f4d1a7a986aa");
        return client.getAcsResponse(request);
    }
    ...
    public void show01() throws ClientException {
        //创建初始化对象
        DefaultAcsClient client = initVodClient("LTAI4GFN6FZixGK5xzXu6Ygf", "0O9ZCSow0JtXrcL2NHcFnhvg8o7Ilg");
        //创建获取视频地址的request和response
        GetPlayInfoRequest request = new GetPlayInfoRequest();
        GetPlayInfoResponse response = new GetPlayInfoResponse();
        //调用初始化对象里面的方法，传递request，获取数据
        request.setVideoId("0fa45727b2974f0e83f3cb7baa507a10");
    ...
    @Test
    public void show2() throws ClientException {
        DefaultAcsClient client = initVodClient("LTAI4GFN6FZixGK5xzXu6Ygf", "0O9ZCSow0JtXrcL2NHcFnhvg8o7Ilg");
        GetVideoPlayAuthRequest request = new GetVideoPlayAuthRequest();
        GetVideoPlayAuthResponse response = new GetVideoPlayAuthResponse();
        request.setVideoId("284edc33e2d14bfd98706b86c7dbf308");
        response = client.getAcsResponse(request);
        System.out.println("playauth:"+response.getPlayAuth());
    }
    @Test
    public void show03() throws ClientException {
